// credit to https://github.com/g1eb/reactjs-calendar-heatmap
  ...
  drawGlobalOverview() {
    ...
    let item_block = this.items.selectAll('.item-block-year')
      ...
      .on('mouseover', (event, d) => {
        ...
        let tooltip_html = ''
        tooltip_html += '<div><span><strong>Total commits:</strong></span>'
  ...
  drawYearOverview() {
    ...
    this.items.selectAll('.item-circle')
      ...
      .on('mouseover', (event, d) => {
        ...
        // Construct tooltip
        let tooltip_html = ''
        tooltip_html += `<div class="${styles.header}"><strong>${d.total ? d.total : 'No time'} commits</strong></div>`
  ...
  drawMonthOverview() {
    ...
    item_block.selectAll('.item-block-rect')
      ...
      .on('mouseover', (event, d) => {
        ...
        tooltip_html += '<div><strong>' + (d.value ? d.value : 'No commits') + ' commits</strong></div>'
